...
ROOT_DIR = Path(__file__).parent.parent.parent  # up three levels
APPS_DIR = ROOT_DIR.joinpath('{{cookiecutter.apps_dir}}')
...
logging.config.dictConfig({
    ...
    'handlers': {
        ...
        'logfile': {
            ...
            'filename': ROOT_DIR.join('log/development.log').value,
